    ...
    while garden_plots:
        ...
        for dir in [(0,1),(0,-1),(1,0),(-1,0)]:
            ...
            if 0 <= nrow < len(grid) and 0 <= ncol < len(grid[0]):
                # print(nrow,ncol, grid[50])
                if grid[nrow][ncol] != '#':
                    next_plots.add((nrow,ncol))
    # print("after")
    # print(len(garden_plots), len(memo["after"]))
    # print_grid(grid, memo["after"])
    ...
    for i in range(5, len(increases)):
        ...
        for start in range(len(increases) - pairsize * 3):
            ...
            for j in range(len(pair)):
                # print("pair", pair, next_pair, next_next_pair, j)
            ...
            if found:
                ...
                break
        # first, second = increases[i-1] , increases[i]
        # if i % 11 == 0:
        #     print(second - first)
# 37 - 36 
...
#                     break
#             if found:
#                 print("found", i, start, pair, next_pair)
#                 break
#         # first, second = increases[i-1] , increases[i]
#         # if i % 11 == 0:
#         #     print(second - first)
